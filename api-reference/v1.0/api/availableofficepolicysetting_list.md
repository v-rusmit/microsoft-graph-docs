# List availableOfficePolicySettings
...
<!-- { "blockType": "ignored" } -->
```http
GET /officepolicies/<Product Name>/availableOfficePolicySettings
```
...
```http
GET https://graph.microsoft.com/v1.0/officePolicies/<Product Name>/availableOfficePolicySettings
```
##### Response
